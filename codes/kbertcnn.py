...
class BertCNN(nn.Module):
    def __init__(self, args, model):
        ...
        self.labels_num = args.labels_num
        # self.pooling = args.pooling
        self.convs = nn.ModuleList([nn.Conv2d(in_channels=1, out_channels=args.hidden_size, kernel_size=(k, args.hidden_size)) for k in (2,3,4)])
...
def main():
    ...
    # Build model.(可修改为bert, lm, cls, mlm, nsp, s2s, bilm)
